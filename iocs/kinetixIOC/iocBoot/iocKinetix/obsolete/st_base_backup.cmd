...
epicsEnvSet("STARTUP_SCRIPT", "$(TOP)/iocBoot/ioc32idKinetix/softioc/32idKinetix.pl")
epicsEnvSet("ENGINEER", "Engbretson")
epicsEnvSet("LOCATION", "Sector 32-ID")
epicsEnvSet("GROUP", "Sector 32-ID")
